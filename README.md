...
- カードに最新コメントのプレビューを表示し、クリックでコメント一覧の確認・投稿・編集
...
コメントが付いているカードには最新コメントの抜粋が表示され、コメント数のバッジから Issue の説明とコメント一覧をモーダルで確認できます。モーダルから新しいコメントを投稿でき、自分のコメントはその場で編集できます。投稿・編集は GitHub API を通じて Issue へ反映され、コメント一覧は開くたびに GitHub API から取得し、D1 へは保存しません。
